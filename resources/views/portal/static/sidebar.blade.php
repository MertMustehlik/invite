...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6 justify-content-center" id="kt_app_sidebar_logo">
        ...
        <a href="{{route("portal.dashboard.index")}}">
            <img alt="Logo" src="{{ asset('logo_white.png') }}" class="h-50px app-sidebar-logo-default"/>
            <img alt="Logo" src="{{ asset('logo_white.png') }}" class="h-20px app-sidebar-logo-minimize"/>
        </a>
        <!--end::Logo image-->
    ...
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <a href="javascript:void(0);"
           ...
           class="btn btn-flex flex-center btn-custom overflow-hidden text-nowrap px-0 h-40px w-100">
            <i class="fa fa-right-from-bracket mt-1"></i>
