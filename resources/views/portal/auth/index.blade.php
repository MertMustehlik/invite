        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="authentication/layouts/corporate/sign-in.html" action="#">
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Email-->
                                <input type="text" placeholder="Email" name="email" value="demo@demo.com" class="form-control bg-transparent" />
                                <!--end::Email-->
                            </div>
                            <!--begin::Input group-->
                            <div class="fv-row mb-8" data-kt-password-meter="true">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="position-relative mb-3">
                                        <input class="form-control bg-transparent" type="password" placeholder="Password" name="password" value="123123" autocomplete="off" />
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(assets/media/misc/auth-bg.png)">
                ...
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    ...
                    <!--end::Image-->
                    <!--begin::Title-->
                    <h1 class="d-none d-lg-block text-white fs-2qx fw-bolder text-center mb-7">Davet Davet Davet</h1>
                    <!--end::Title-->
                    <!--begin::Text-->
                    <div class="d-none d-lg-block text-white fs-base text-center">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia repudiandae eveniet vitae omnis iusto atque consequatur aliquid amet, tenetur sed, exercitationem maxime voluptatum accusantium soluta aliquam velit obcaecati. Rerum, velit.
                    </div>
                    <!--end::Text-->
                </div>
                <!--end::Content-->
